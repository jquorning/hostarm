...
package CGI is
   ...
   --  These routines find the Index'th value of that key (normally the
   --  first one).
   function Value (
   ...
   --  This is called at the end of an HTML document. It puts to
   --  Current_Output:
   --    </body></html>
   ...
   --  filtered; the user may be unknowingly clicking though a malicious link.
